...
import { UserController } from './modules/users/adapters/http/user.controller';
import { UserService } from './modules/users/application/user.service';
import { StatsController } from './modules/dashboard/stats.controller';
import { StatsService } from './modules/dashboard/stats.service';
...
@Module({
  ...
  controllers: [HealthController, AuthController, SpecialtyController, DoctorController, PatientController, AppointmentController, UserController, StatsController],
