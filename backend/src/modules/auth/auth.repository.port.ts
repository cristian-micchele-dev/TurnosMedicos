export interface AuthSession {id:string; userId:string; familyId:string; tokenHash:string; jti:string; expiresAt:Date; persistent?:boolean; revokedAt?:Date; replacedBy?:string}
